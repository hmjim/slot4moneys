								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="casino-item">
										<div class="casino-icon">
											<a href="<?php the_permalink(); ?>"><img src="<?php echo kama_thumb_src("w=189 &h=132") ?>" title="Игровой автомат <?php the_title(); ?>"></a>
										</div>
										...
										<div class="casino-btns">
											<a href="<?php the_permalink(); ?>" class="casino-btn-1" title="Играть в <?php the_title(); ?>">Бесплатно</a>
