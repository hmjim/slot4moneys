    ...
    class BhittaniPlugin_kkStarRatings extends BhittaniPlugin
    {
        ...
        */
        public function css_custom()
        {
            ...
            $star_gray = parse_url(parent::get_options('kksr_stars_gray'))['path'];
            $star_yellow = parse_url(parent::get_options('kksr_stars_yellow'))['path'];
            $star_orange = parse_url(parent::get_options('kksr_stars_orange'))['path'];
