...
<input type="submit" class="button" style="margin-top: 10px" value="Измененить пароль">
    ...
    {
        $changeStatus='<form action="" method="post" class="form-horizontal">
    <input type="hidden" name="action" value="change_status">
    <input type="hidden" name="change_status" value="0">
    <input type="submit" class="button" style="margin-top: 10px" value="Выключить Smartwall">';
    }
    else
    {
    ...
    <input type="submit" class="button" style="margin-top: 10px" value="Включить Smartwall">';
    }
    $changeStatus.='</form>';
...
<h1 class="wp-heading-inline">Настройка модуля Smartwall - сборка 2020-03-16 (';
    if ($smart_config[ 'status' ]==1)
...
<form action="" method="post" class="form-horizontal">
    ...
    <div class="box">
        ...
        <div class="row box-section">
            ...
            <a href="?need_update_now=1" style="text-decoration:none"><div class="button" style="text-decoration:none">Обновить базу данных сейчас</div></a><br>
